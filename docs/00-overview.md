...
| **Token name / symbol** | `LineaDAT` / **`LINEADAT`** | |
| **Total supply** | 1 000 000 000 × 10¹⁸ | разовый mint в `initialize`, далее только burn |
| **Decimals** | 18 | ERC-20 standard |
| **Initial pool** | single-sided: 0 ETH + 1B LineaDAT | LP-NFT в `0xdead` сразу |
| **Initial FDV** | ≈ $100 000 | sqrtPriceX96 калибруется под `1 ETH ≈ 40M LineaDAT` (как WBTCSTR) |
...
| | REKTSTR (v2) | WBTCSTR (v3) | LineaDAT (forked v3) |
|---|---|---|---|
| Версия | 2 | 3 | 3 (форк) |
