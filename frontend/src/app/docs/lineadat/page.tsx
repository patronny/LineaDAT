...
export const metadata: Metadata = { title: "LINEADAT" };
...
export default function LineadatDocPage() {
  return (
    <>
      ...
      <p>
        <code>$LINEADAT</code> is the main ecosystem token of{" "}
      ...
      <p>
        ...
        <code>$LINEADAT</code>. In other words, every new DAT inside the
        ecosystem will additionally feed <code>$LINEADAT</code> and strengthen
        its deflationary mechanics.
      </p>

      <p>
        Every <code>$LINEADAT</code> trade executed through the{" "}
        <a
      ...
      <ul>
        <li>
          ...
          inside the <code>$LINEADAT</code> treasury.
        </li>
        <li>
      ...
      <p>
        After launch, the <code>$LINEADAT</code> contract will go through
      ...
      <p>
        ...
        <code>$LINEADAT</code> will become the base ecosystem token of{" "}
      ...
      <p>
        To protect <code>$LINEADAT</code> and other <code>$XXXDAT</code> tokens
